    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Box sx={{ overflow: 'auto', p: 2 }}>
          ...
          <Box sx={{ mt: 2 }}>
            <Button fullWidth variant="contained" startIcon={<PersonIcon />} sx={{ mb: 1 }}>
              Users
            </Button>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ bgcolor: '#e8f5e8' }}>
              <CardContent>
                ...
                <Typography variant="h4">{approvedUsers}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ bgcolor: '#fff3e0' }}>
              <CardContent>
                ...
                <Typography variant="h4">{pendingUsers}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
